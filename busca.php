...
<div style="background-color: #333; padding: 10px; text-align: center; border-radius: 5px; display: flex; justify-content: center; gap: 20px; position: fixed; top: 0; width: 100%;">
  ...
  <a href="localhost/formulario/busca.php" style="color: white; text-decoration: none; font-size: 16px; padding: 8px 12px; background-color: #555; border-radius: 5px;">🔍 Buscar Aluno</a>
</div>
